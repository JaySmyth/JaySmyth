...
<div class="clearfix">
    ...
    <h2 class="float-right"><span class="badge badge-{{$shipment->seaFreightStatus->code}}">{{$shipment->seaFreightStatus->name}}</span></h2>
</div>
...
<div class="row mb-4">
    ...
    <div class="col-sm-6">
        <div id="panel-show-summary" class="card h-100">
            <div class="card-header">
                ...
                <div class="float-right">
                    <button id="button-additional-information" class="btn btn-outline-secondary btn-sm btn-xs" type="button">Additional Information</button>
                </div>
                @endif
            </div>
            <div class="card-body text-large">
                ...
                <div class="row mb-2">
                    <div class="col-sm-5"><span class="fas fa-fw fa-industry" aria-hidden="true"></span> <strong class="ml-sm-3">Shipping Line</strong></div>
                    <div class="col-sm-7">
                ...
                <div class="row mb-2">
                    <div class="col-sm-5"><span class="fas fa-fw fa-file" aria-hidden="true"></span> <strong class="ml-sm-3">Bill of Lading</strong></div>
                    <div class="col-sm-7">
                        @if($shipment->processed)
                ...
                <div class="row mb-2">
                    <div class="col-sm-5"><span class="fas fa-fw fa-calendar" aria-hidden="true"></span> <strong class="ml-sm-3">@if(!$shipment->departure_date)Estimated @endif Departure Date</strong></div>
                    <div class="col-sm-7">
                        @if($shipment->processed)
                ...
                <div class="row mb-2">
                    <div class="col-sm-5"><span class="fas fa-fw fa-calendar" aria-hidden="true"></span> <strong class="ml-sm-3">@if(!$shipment->arrival_date)Estimated @endif Arrival Date</strong></div>
                    <div class="col-sm-7">
                        @if($shipment->processed)
                ...
                <div class="row mb-2">
                    <div class="col-sm-5"><span class="fas fa-fw fa-map-marker" aria-hidden="true"></span> <strong class="ml-sm-3">Port of Loading</strong></div>                    
                    <div class="col-sm-7">
                        @if($shipment->processed)
                ...
                <div class="row mb-2">
                    <div class="col-sm-5"><span class="fas fa-fw fa-map-marker" aria-hidden="true"></span> <strong class="ml-sm-3">Port of Discharge</strong></div>                    
                    <div class="col-sm-7">
                        @if($shipment->processed)
                ...
                <div class="row mb-2">
                    <div class="col-sm-5"><span class="fas fa-fw fa-ship" aria-hidden="true"></span> <strong class="ml-sm-3">Vessel</strong></div>
                ...
                <div class="row mb-2">
                    <div class="col-sm-5"><span class="far fa-clock fa-fw" aria-hidden="true"></span> <strong class="ml-sm-3">Transit</strong></div>
                    <div class="col-sm-7">{{$shipment->timeInTransit}} Days In Transit</div>
                </div>
                <div class="row mb-2">
                    <div class="col-sm-5"><span class="far fa-clock fa-fw" aria-hidden="true"></span> <strong class="ml-sm-3">Remaining</strong></div>
                    <div class="col-sm-7">
        ...
        @if(Auth::user()->hasIfsRole())
        <div id="panel-show-additional-information" class="card">
            <div class="card-header">
                Additional Information
                <div class="float-right">
                    <button id="button-additional-information-return" class="btn btn-outline-secondary btn-sm btn-xs" type="button">Summary</button>
                </div>
            </div>
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-sm-5"><strong>SCS Number</strong></div>
                    <div class="col-sm-7">{{$shipment->scs_job_number ?? 'Unknown'}}</div>
                </div>
            </div>
        </div>
        @endif
