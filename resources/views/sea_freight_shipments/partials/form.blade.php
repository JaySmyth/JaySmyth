<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group row{{ $errors->has('required_on_dock_date') ? ' has-danger' : '' }}">
            ...
            <div class="col-sm-6">
                ...
                @if(Request::is('sea-freight/*/edit'))
                    {!! Form::select('required_on_dock_date', dropDown('datesLong'), old('required_on_dock_date', date('d-m-Y', strtotime($shipment->required_on_dock_date))), array('id' => 'required_on_dock_date', 'class' => 'form-control')) !!}
                @else
    ...
    @if(Request::is('sea-freight/*/edit') && Auth::user()->hasIfsRole())
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group row{{ $errors->has('estimated_departure_date') ? ' has-danger' : '' }}">
                ...
                <div class="col-sm-6">
                    {!! Form::select('estimated_departure_date', dropDown('datesLong', 'Not specified'), old('estimated_departure_date', date('d-m-Y', strtotime($shipment->estimated_departure_date))), array('id' => 'estimated_departure_date', 'class' => 'form-control')) !!}
            ...
            <div class="form-group row{{ $errors->has('departure_date') ? ' has-danger' : '' }}">
                <label class="col-sm-5  col-form-label">
                    Departure Date: <abbr title="This information is required.">*</abbr>
                </label>

                <div class="col-sm-6">
                    {!! Form::select('departure_date', dropDown('datesLong', 'Not specified'), old('departure_date', date('d-m-Y', strtotime($shipment->departure_date))), array('id' => 'departure_date', 'class' => 'form-control')) !!}
            ...
            <div class="form-group row{{ $errors->has('estimated_arrival_date') ? ' has-danger' : '' }}">
                ...
                <div class="col-sm-6">
                    {!! Form::select('estimated_arrival_date', dropDown('datesLong', 'Not specified'), old('estimated_arrival_date', date('d-m-Y', strtotime($shipment->estimated_arrival_date))), array('id' => 'estimated_arrival_date', 'class' => 'form-control')) !!}
            ...
            <div class="form-group row{{ $errors->has('arrival_date') ? ' has-danger' : '' }}">
                <label class="col-sm-5  col-form-label">
                    Arrival Date: <abbr title="This information is required.">*</abbr>
                </label>

                <div class="col-sm-6">
                    {!! Form::select('arrival_date', dropDown('datesLong', 'Not specified'), old('arrival_date', date('d-m-Y', strtotime($shipment->arrival_date))), array('id' => 'arrival_date', 'class' => 'form-control')) !!}
