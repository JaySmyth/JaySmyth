...
<h2 class="float-left">
    ...
    <small class="text-muted ml-sm-4">{{App\Models\Department::find(Request::get('department'))->first()->name}}</small>
    @endif

    @if(Request::get('company'))   
     <small class="text-muted ml-sm-4">{{App\Models\Company::find(Request::get('company'))->first()->company_name}}</small>
    @endif
