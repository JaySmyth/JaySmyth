...
@section('toolbar')
<a href="{{ url('/purchase-invoices/copy-docs-email') }}" title="Send Copy Docs Email"><span class="fas fa-envelope fa-lg" aria-hidden="true"></span></a>
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        <tr>
            <td><a href="{{ url('/purchase-invoices', $invoice->id) }}" class="invoice-number">{{$invoice->invoice_number}}</a></td>
            ...
            <td class="text-center"><span class="badge {{($invoice->type == 'F') ? 'badge-primary' : 'badge-secondary'}}" aria-hidden="true" data-placement="right" data-toggle="tooltip" data-original-title="{{verboseInvoiceType($invoice->type)}} Invoice">{{$invoice->type}}</span></td>
            <td class="text-center"><span aria-hidden="true" data-placement="right" data-toggle="tooltip" data-original-title="{{verboseImportExport($invoice->import_export)}}">{{$invoice->import_export ?? 'n/a'}}</span></td>
