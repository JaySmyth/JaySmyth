    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    @if(Auth::user()->hasMultipleModes())
                        ...
                        <li class="nav-item dropdown ml-sm-2">
                            ...
                            <div class="dropdown-menu">
                                ...
                                @can('sea')
                                    <a class="dropdown-item" href="{{url('/sea-freight/create')}}">Sea Freight</a>@endcan
            ...
            <ul class="navbar-nav mr-sm-1">
                ...
                <li class="nav-item dropdown ml-sm-2">
                    <a class="nav-link dropdown-toggle text-nowrap" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><span class="fas fa-fw fa-user fa-lg text-white" aria-hidden="true"></span> {{Auth::user()->name }}
                    </a>
