<div class="col-sm-6">
    ...
    <div class="form-group row{{ $errors->has('company_id') ? ' has-danger' : '' }}">
        ...
        <div class="col-sm-6">
            {!! Form::select('company_id', dropDown('enabledSites', 'Please select'), old('company_id'), array('id' => 'company_id', 'class' => 'form-control, customs-company-id')) !!}
