...
<div class="row">
    <div class="col-sm-5">
        ...
        <div class="form-group row{{ $errors->has('document_type') ? ' has-danger' : '' }}">
            ...
            <div class="col-sm-9">
                {!! Form::select('document_type',['' => 'Please Select', 'invoice' => 'Invoice', 'despatch' => 'Despatch Note', 'other' => 'Other'], old('document_type'), array('id' => 'document_type', 'class' => 'form-control')) !!}
