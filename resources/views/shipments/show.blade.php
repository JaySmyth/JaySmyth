...
@section('content')
    ...
    <div class="row mb-4">
        ...
        <div class="col-sm-5">
            <div id="panel-show-summary" class="card h-100">
                ...
                <div class="card-body text-large">
                    <div class="row mb-2">
                        <div class="col-sm-6"><span class="far fa-building fa-fw" aria-hidden="true"></span>
                            <strong class="ml-sm-3">Shipper</strong></div>
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6"><span class="fas fa-paperclip fa-fw" aria-hidden="true"></span>
                            <strong class="ml-sm-3">Reference</strong></div>
                        <div class="col-sm-6">{{$shipment->shipment_reference}}</div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-6"><span class="far fa-calendar-alt fa-fw" aria-hidden="true"></span>
                            <strong class="ml-sm-3">Ship Date</strong></div>
                        <div class="col-sm-6">{{$shipment->ship_date->timezone(Auth::user()->time_zone)->format(Auth::user()->date_format)}}</div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-6"><span class="fas fa-balance-scale fa-fw" aria-hidden="true"></span>
                            <strong class="ml-sm-3">Weight</strong></div>
                        <div class="col-sm-6">{{$shipment->weight}} {{$shipment->weight_uom}}</div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-6"><span class="fas fa-dollar-sign fa-fw" aria-hidden="true"></span>
                            <strong class="ml-sm-3">Value</strong></div>
                        <div class="col-sm-6">{{number_format($shipment->customs_value, 2)}} {{$shipment->customs_value_currency_code}}</div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-6"><span class="fas fa-cube fa-fw" aria-hidden="true"></span>
                            <strong class="ml-sm-3">Vol. Weight</strong></div>
                        <div class="col-sm-6">{{$shipment->volumetric_weight}} {{$shipment->weight_uom}}</div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-sm-6 text-truncate"><span class="far fa-clock fa-fw" aria-hidden="true"></span>
                            <strong class="ml-sm-3">Time in Transit</strong></div>
                        <div class="col-sm-6">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6"><span class="fas fa-file-signature fa-fw" aria-hidden="true"></span>
                            <strong class="ml-sm-3">POD Signature</strong></div>
                        <div class="col-sm-6">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6"><span class="far fa-calendar-alt fa-fw" aria-hidden="true"></span>
                            <strong class="ml-sm-3">Delivery Date</strong></div>
                        <div class="col-sm-6">
                ...
                <div id="panel-show-additional-information" class="card h-100">
                    ...
                    <div class="card-body text-large">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6 text-truncate">{{$shipment->service->carrier_name}}
                                <span class="badge badge-secondary">{{$shipment->service->carrier_code}}</span></div>
                        </div>
                        <div class="row mb-2">
    ...
    @if($shipment->contents->count() > 0)
        ...
        <h4 class="mb-2">Contents
            <span class="badge badge-pill badge-secondary badge-sm ml-sm-1">{{ $shipment->contents->count()}}</span>
        </h4>
        <table class="table table-striped table-bordered mb-5">
            <thead>
            <tr>
    ...
    @if($shipment->alerts->count() > 0)
        ...
        <h4 class="mb-2">Alerting
            <span class="badge badge-pill badge-secondary badge-sm ml-sm-1">{{ $shipment->alerts->count()}}</span></h4>
        <table class="table table-striped table-bordered mb-5">
            <thead>
            <tr>
                <th>#</th>
    ...
    @if(Auth::user()->hasIfsRole() && $shipment->transportJobs->count() > 0)
        ...
        <h4 class="mb-2">Transport Jobs
            <span class="badge badge-pill badge-secondary badge-sm ml-sm-1">{{ $shipment->transportJobs->count()}}</span>
        </h4>
        ...
        <table class="table table-striped table-bordered mb-5">
            ...
            @foreach ($shipment->transportJobs as $transportJob)
                <tr>
                    ...
                    <td class="text-center">
                        <span class="status {{$transportJob->status->code}}" data-placement="bottom" data-toggle="tooltip" data-original-title="{{$transportJob->status->description}}">{{$transportJob->status->name}}</span>
                    </td>
                </tr>
            @endforeach
            </tbody>
