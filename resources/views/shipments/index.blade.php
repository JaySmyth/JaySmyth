...
@section('toolbar')   
@can('download_shipments')<a href="shipments/download?{{Request::getQueryString()}}" title="Download Results"><span class="fas fa-cloud-download-alt fa-lg" aria-hidden="true"></span></a>@endcan
...
<table class="table table-striped">
    <thead>
        <tr>
            <th>Consignment</th>
            <th>Carrier Ref</th>
            @if(Auth::user()->hasRole('ifsf'))<th>SCS Job</th>@endif
            ...
            <th class="text-center">Weight <span class="fas fa-info-circle" aria-hidden="true" data-placement="bottom" data-toggle="tooltip" data-original-title="Chargeable weight - largest value from weight or volumetric weight"></span></th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center text-nowrap"><span class="status {{$shipment->status->code}}" data-placement="bottom" data-toggle="tooltip" data-original-title="{{$shipment->status->description}}">{{$shipment->status->name}}</span></td>
