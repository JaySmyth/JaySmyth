...
@if(isset($formView))
<h3 class="mt-3 float-left">Shipment - {{ $shipment->consignment_number }} <small class="ml-sm-3 text-muted"><span class="fas fa-window-restore mr-sm-1" aria-hidden="true"></span> Form View</small></h3>
<div class="clearfix"></div>
@else
<h3 class="mt-3 float-left text-secondary"><span class="fas fa-floppy-o mr-sm-1" aria-hidden="true"></span> Saved Shipment <small>{{ $shipment->consignment_number }}</small></h3>
@endif
...
<div id="shipment">
    ...
    <div class="float-right mb-2">
        <button id="button-proceed" class="ml-md-4 btn btn-primary btn-lg btn-shadow" type="button">Proceed to Final Step <span class="fas fa-chevron-right" aria-hidden="true"></span></button>
    </div>
    <div class="clearfix"></div>
    @endif
        ...
        <div class="col-md-8">
            ...
            <div id="panel-details" class="card mb-2">
                ...
                <div class="card-header font-weight-bold pt-1 pb-1 font-weight-bold pt-1 pb-1 clearfix">
                    ...
                    <button id="button-save-shipment" class="btn btn-secondary btn-sm btn-xs float-right" type="button"><span class="far fa-save" aria-hidden="true"></span> Save Shipment</button>
                    @endif
                </div>
                ...
                <div class="card-body pt-2 pb-2 mt-2 text-nowrap">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="form-group row">
                                <label class="col-md-5 col-form-label">
                                    Ship Reason: <abbr title="This information is required for Commercial Invoices.">*</abbr>
                                </label>
                                <div class="col-md-7">
                        ...
                        <div class="col-md-2">
                            <div class="btn-group-vertical btn-group-sm float-right" role="group" aria-label="">
                                ...
                                @can('courier_billing')<button id="button-billing" type="button" class="btn btn-outline-secondary">Billing</button>@endcan
                                @can('courier_broker')<button id="button-broker" type="button" class="btn btn-outline-secondary">Broker</button>@endcan
            ...
            <div id="panel-alerts" class="card mb-2">
                ...
                <div class="card-header font-weight-bold pt-1 pb-1">Alerts <span class="fas fa-info-circle" aria-hidden="true" data-placement="bottom" data-toggle="tooltip" data-original-title="This panel allows you to define the email alerts to be generated for your shipment. You MUST enter valid sender/recipient email addresse and tick the desired alerts. To send email alerts to an additional email address, enter a valid email address into the 'other' field."></span>
            ...
            <div id="panel-billing" class="card mb-2">
                <div class="card-header font-weight-bold pt-1 pb-1">Billing <span class="fas fa-info-circle" aria-hidden="true" data-placement="bottom" data-toggle="tooltip" data-original-title="This panel allows you to define custom billing information. Any account numbers provided must be valid carrier account numbers for the service to be selected."></span>
                    <div class="float-right">
            ...
            <div id="panel-broker" class="card mb-2">
                <div class="card-header font-weight-bold pt-1 pb-1">Broker <span class="fas fa-info-circle" aria-hidden="true" data-placement="bottom" data-toggle="tooltip" data-original-title="This panel allows you to specify a 3rd party for customs clearance purposes."></span>
                    <div class="float-right">
            ...
            <div id="panel-options" class="card mb-2">
                <div class="card-header font-weight-bold pt-1 pb-1">Options <span class="fas fa-info-circle" aria-hidden="true" data-placement="bottom" data-toggle="tooltip" data-original-title="This panel allows you to specify any special requirements or miscellaneous options for your shipment."></span>
                    <div class="float-right">
                        ...
                        <div class="col-md-6">
                            ...
                            <fieldset id="dry-ice-fieldset">
                                ...
                                <div class="form-group row item">
                                    <label class="col-md-5 col-form-label">Dry Ice Weight (Pkg <span class="package-number">{{$loop->iteration}}</span>)</label>
                                    <div class="col-md-5">
            ...
            <div id="panel-packages"  class="card mb-2">
                ...
                <div class="card-header font-weight-bold pt-1 pb-1">
                    ...
                    Package Details <span class="fas fa-info-circle" aria-hidden="true" data-placement="bottom" data-toggle="tooltip" data-original-title="This panel allows you to define the weights and dimensions of your packages. If you have more than one package, the duplicate button will 'fill down' the weight and dimensions of the first package. To add or remove packages, change the number in the 'Pieces' field above. You must provide the correct weight and dimensions for every package."></span>

                    @else

                    <div class="d-flex justify-content-between">
                        <div>Package Details <span class="fas fa-info-circle" aria-hidden="true" data-placement="bottom" data-toggle="tooltip" data-original-title="This panel allows you to define the weights and dimensions of your packages. If you have more than one package, the duplicate button will 'fill down' the weight and dimensions of the first package. To add or remove packages, change the number in the 'Pieces' field above. You must provide the correct weight and dimensions for every package."></span></div>
                        <div><div id="largest_girth" class="font-italic font-weight-normal text-muted"></div></div>
                        <div><button id="button-duplicate" class="btn btn-outline-secondary btn-sm btn-xs" type="button">Duplicate</button></div>
                    </div>
            ...
            <div id="panel-contents"  class="card">
                <div class="card-header font-weight-bold pt-1 pb-1">
                    Shipment Contents <span class="fas fa-info-circle" aria-hidden="true" data-placement="bottom" data-toggle="tooltip" data-original-title="This panel allows you to define what is contained within each of your packages. There MUST be at least one line for every package. For shipments with multiple packages but only one commodity, use the 'Fill' button to autocomplete the package contents for you (the 'Fill' button is only displayed when appropriate)."></span>
                    <div class="float-right">
                        <button id="button-fill" class="btn btn-outline-secondary btn-sm btn-xs" type="button">Fill</button> <button type="button" id="button-add-commodity" class="btn btn-outline-secondary btn-sm btn-xs" data-toggle="modal" data-target="#commodities">Add Commodity</button>
                    </div>
                </div>
                <div id="container-contents" class="card-body pt-2 pb-2 text-nowrap">
                    ...
                    <div id="commodity-{!! $key !!}" class="form-group row item">
                        ...
                        <div class="col-md-2">
                            <div class="input-group input-group-sm">
                                ...
                                <div class="input-group-append"><span id="currency_code_1" class="input-group-text text-uppercase">KG</span></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="input-group input-group-sm">
                                ...
                                <div class="input-group-append"><span id="currency_code_1" class="input-group-text text-uppercase">GBP</span></div>
                            </div>
                        </div>
                    ...
                    <div id="customs-information" class="well well-lg text-center mt-5">
                        Please describe the contents of your shipment. Click the <strong>Add Commodity</strong> button to get started.
                    </div>
                    @endif
...
<div id="summary">
    ...
    <button id="button-previous" class="btn btn-primary btn-lg btn-shadow float-right" type="button"> <span class="fas fa-chevron-left" aria-hidden="true"></span> Previous Screen</button>
    ...
    <div class="row mb-2">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header font-weight-bold pt-1 pb-1"><span class="fas fa-user" aria-hidden="true"></span> Sender / Recipient</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <address id="summary-sender">
                                ...
                                <span id="summary_sender_city"></span>, <span id="summary_sender_state"></span> <span id="summary_sender_postcode"></span><br>
                        ...
                        <div class="col-md-5">
                            <address id="summary-recipient">
                                ...
                                <span id="summary_recipient_city"></span>, <span id="summary_recipient_state"></span> <span id="summary_recipient_postcode"></span><br>
        ...
        <div class="col-md-4">
            ...
            <div class="card h-100">
                ...
                <div class="card-body pt-2 pb-2 text-nowrap text-large">
                    <div class="row mb-2">
                        <div class="col-md-5"><span class="fas fa-fw fa-paperclip mr-sm-3" aria-hidden="true"></span> <strong>Ship Ref</strong></div>
                        <div id="summary_shipment_reference" class="col-md-7"></div>
                    </div>

                    <div class="row mb-2">
                        <div class="col-md-5"><span class="fas fa-fw fa-calendar mr-sm-3" aria-hidden="true"></span> <strong>Collection</strong></div>
                        <div id="summary_collection_date" class="col-md-7"></div>
                    </div>

                    <div class="row mb-2">
                        <div class="col-md-5"><span class="fas fa-fw fa-random mr-sm-3" aria-hidden="true"></span> <strong>Ship Reason</strong></div>
                        <div id="summary_ship_reason" class="col-md-7"></div>
                    </div>

                    <div class="row mb-2">
                        <div class="col-md-5"><span class="fas fa-fw fa-fire mr-sm-3" aria-hidden="true"></span> <strong>Hazardous</strong></div>
                        <div id="summary_hazardous" class="col-md-7"></div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-md-5"><span class="fas fa-fw fa-user mr-sm-3" aria-hidden="true"></span> <strong>Bill To</strong></div>
                        <div class="col-md-7"><span id="summary_bill_shipping" title="Bill Shipping To">Default</span> | <span id="summary_bill_tax_duty" title="Bill Tax And Duty To">Default</span></div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-md-5"><span class="fas fa-fw fa-credit-card mr-sm-3" aria-hidden="true"></span> <strong>Bill Account</strong></div>
                        <div class="col-md-7"><span id="summary_bill_shipping_account" title="Bill Shipping To Account">Default</span> | <span id="summary_bill_tax_duty_account" title="Bill Tax And Duty To Account">Default</span></div>
                    </div>
                    <div class="row">
                        <div class="col-md-5"><span class="fas fa-fw fa-list mr-sm-3" aria-hidden="true"></span> <strong>Options</strong></div>
                        <div class="col-md-7">
                            <span id="no-options-selected">None selected</span>
                            <ul id="summary_options" class="list-inline">
                                <li class="list-inline-item" id="summary_insured"><span class="fas fa-fw fa-check text-success" aria-hidden="true"></span> Insured</li>
                                <li class="list-inline-item" id="summary_alcohol"><span class="fas fa-fw fa-check text-success" aria-hidden="true"></span> Alcohol</li>
                                <li class="list-inline-item" id="summary_dry_ice"><span class="fas fa-fw fa-check text-success" aria-hidden="true"></span> Dry Ice</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="card">
                ...
                <div class="card-body pt-2 pb-1 text-nowrap text-large">
                    ...
                    <div class="row border-bottom pt-2 pb-2">
                        <div class="col-md-6">
                            <strong>Value:</strong> <span class="fas fa-info-circle" aria-hidden="true" data-placement="right" data-toggle="tooltip" data-original-title="Shipment value is calculated from the commodity values entered on the previous screen (quantity x unit value for each line)."></span>
                        </div>
                        <div class="col-md-6">
                            <div class="float-right">
                                <span id="summary_customs_value">0.00</span> <span id="summary_customs_value_currency_code"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row border-bottom pt-2 pb-2">
                        <div class="col-md-6">
                            <strong>Weight:</strong> <span class="fas fa-info-circle" aria-hidden="true" data-placement="right" data-toggle="tooltip" data-original-title="The total weight of your shipment - rounded up to the nearest half KG"></span>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row border-bottom pt-2 pb-2">
                        <div class="col-md-7">
                            <strong>Volumetric Weight:</strong> <span class="fas fa-info-circle" aria-hidden="true" data-placement="bottom" data-toggle="tooltip" data-original-title="Some useful info about vol weight here - rounded up to the nearest half KG"></span>
                        </div>
                        <div class="col-md-5">
                    ...
                    <div class="row border-bottom pt-2 pb-2">
                        <div class="col-md-12">
                            <h3 class="m-0 p-0">Total: <span id="summary_total" class="text-primary ml-sm-1"></span> <span class="text-small text-muted ml-sm-1">exc. VAT</span></h3>
                        </div>
                    </div>
    ...
    <div class="float-right">
        <button id="button-create" class="ml-md-4 btn btn-success text-white btn-lg btn-shadow" type="submit"><span class="fas fa-print" aria-hidden="true"></span> Create Label</button>
    </div>
