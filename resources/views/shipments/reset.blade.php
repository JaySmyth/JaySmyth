            ...
            <div class="col-5">
                ...
                <div class="form-group row{{ $errors->has('service') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-6">
                        ...
                        @else
                            {!! Form::select('service',  [16 => ' UPS UK24', 27 => 'DHL Worldwide Express (NonDoc)', 81 => 'DHL Worldwide Express EU (NonDoc)', 22 => 'DHL Economy Select (NonDoc)', 76 => 'XDP UK48', 19 => 'FedEx UK', 64 => 'IE48 - An Post', 85 => 'IE48 - JMC'], old('service') ?? '76', array('class' => 'form-control')) !!}
                        @endif
