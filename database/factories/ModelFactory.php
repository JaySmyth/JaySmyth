...
$factory->define(App\Shipment::class, function (Faker\Generator $faker) {
    return [
        ...
        'invoice_run_id' => null,
        'token' => str_random(15),
        'sender_type' => $faker->randomElement(array('r', 'c')),
        ...
        'shipment_reference' => $faker->randomElement(array(str_random(5), str_random(12), $faker->company, str_random(9), $faker->word, $faker->name)),
        'recipient_type' => $faker->randomElement(array('r', 'c')),
        ...
        'documents_description' => $faker->randomElement(array('BUSINESS DOCUMENTS ONLY', 'Legal Documents', 'Manuals')),
        'goods_description' => $faker->word,
        'pallet' => $faker->boolean(),
        'bill_shipping' => $faker->randomElement(array('sender', 'recipient', 'other')),
        'bill_tax_duty' => $faker->randomElement(array('sender', 'recipient', 'other')),
        ...
        'hazardous' => $faker->randomElement(array('N', 'E', 1, 2, 3, 4, 5, 6, 7, 8, 9)),
        'pieces' => $faker->numberBetween(1, 3),
        'alcohol_type' => $faker->randomElement(array('', 'a', 'b', 'w')),
        'alcohol_packaging' => $faker->randomElement(array('bt', 'bl', 'cn')),
        'alcohol_volume' => $faker->numberBetween(5, 15),
        'alcohol_quantity' => $faker->numberBetween(1, 25),
        'dry_ice_flag' => $faker->randomElement(array(0, 1, 2)),
        ...
        'ship_reason' => $faker->randomElement(array('sold', 'documents', 'gift', 'sample', 'transfer')),
...
$factory->define(App\Address::class, function (Faker\Generator $faker) {
    return [
        ...
        'email' => $faker->email,
        'type' => $faker->randomElement(array('r', 'c')),
        'definition' => $faker->randomElement(array('sender', 'recipient')),
    ];
});
...
$factory->define(App\Commodity::class, function (Faker\Generator $faker) {
    return [
        ...
        'currency_code' => $faker->randomElement(array('GBP', 'USD')),
...
$factory->define(App\Package::class, function (Faker\Generator $faker) {
    return [
        ...
        'location' => $faker->randomElement(array('sort', 'hold')),
...
$factory->define(App\ShipmentContent::class, function (Faker\Generator $faker) {
    return [
        ...
        'uom' => $faker->randomElement(array('ea', 'ml', 'mg', 'l')),
        'unit_value' => $faker->numberBetween(1, 30),
        'currency_code' => $faker->randomElement(array('GBP', 'USD', 'EUR')),
        'unit_weight' => $faker->numberBetween(1, 5),
        'weight_uom' => 'kg',
        'shipment_id' => $faker->numberBetween(1, 50),
    ];
...
$factory->define(App\Tracking::class, function (Faker\Generator $faker) {
    return [
        ...
        'carrier' => $faker->randomElement(array('FedEx', 'UPS', 'DHL', 'TNT')),
        'city' => $faker->city,
        'state' => $faker->state,
        'country_code' => $faker->countryCode,
        'postcode' => $faker->postcode,
        'source' => $faker->randomElement(array('easypost', 'ifs')),
