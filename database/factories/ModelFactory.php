...
$factory->define(App\Models\Models\Address::class, function (Faker\Generator $faker) {
    return [
...
$factory->define(App\Models\ShipReason::class, function (Faker\Generator $faker) {
    return [
        'reason' => $faker->word,
        'enabled' => 1,
    ];
...
$factory->define(App\Models\Models\Commodity::class, function (Faker\Generator $faker) {
    return [
        'company_id' => $faker->numberBetween(1, 10),
...
$factory->define(App\Models\ShipmentContent::class, function (Faker\Generator $faker) {
    return [
...
$factory->define(App\Models\Models\Label::class, function (Faker\Generator $faker) {
    return [
