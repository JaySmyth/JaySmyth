...
class ShipmentsController extends Controller
{
    ...
    public function resetShipment(Shipment $shipment, Request $request)
    {
        ...
        Mail::to(['aplatt@antrim.ifsgroup.com', 'courieruk@antrim.ifsgroup.com', 'markj@antrim.ifsgroup.com', 'epalframan@antrim.ifsgroup.com'])->queue(new \App\Mail\ShipmentWarning($shipment, 'reset', $request->reason));
