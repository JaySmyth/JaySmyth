            ...
            if ($this->createPurchaseInvoice($summary)) {
                ...
                foreach ($invoice['details'] as $details) {
                    ...
                    if ($details['Inv No'] == $summary['Inv No'] && $details['Acct No'] == $summary['Acct No']) {
                        ...
                        $charges = array(
                            $details['Charge Type'] => array('amount' => 'FRT Net charge', 'tax' => 'FRT Tax Indicator'), // The main charge type of the detail line (SHP/RTN/ADJ)
                            'FSC' => array('amount' => 'Fuel Net charge', 'tax' => 'Fuel Tax Indicator'),
                            $details['Inv rel charges Code'] => array('amount' => 'Inv related charge net', 'tax' => 'Inv related charge Tax indicator'),
                            $details['ACC1 Code'] => array('amount' => 'ACC1 Net charge', 'tax' => 'ACC1 Tax indicator'),
                            $details['ACC2 Code'] => array('amount' => 'ACC2 Net charge', 'tax' => 'ACC2 Tax indicator'),
                            $details['ACC3 Code'] => array('amount' => 'ACC3 Net charge', 'tax' => 'ACC3 Tax indicator'),
                            $details['ACC4 Code'] => array('amount' => 'ACC4 Net charge', 'tax' => 'ACC4 Tax indicator'),
                            $details['ACC5 Code'] => array('amount' => 'ACC5 Net charge', 'tax' => 'ACC5 Tax indicator'),
                            $details['ACC6 Code'] => array('amount' => 'ACC6 Net charge', 'tax' => 'ACC6 Tax indicator'),
                            $details['ACC7 Code'] => array('amount' => 'ACC7 Net charge', 'tax' => 'ACC7 Tax indicator'),
                            $details['ACC8 Code'] => array('amount' => 'ACC8 Net charge', 'tax' => 'ACC8 Tax indicator')
                        );
