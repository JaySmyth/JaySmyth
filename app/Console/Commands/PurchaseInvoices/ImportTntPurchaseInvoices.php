...
class ImportTntPurchaseInvoices extends Command
{
     ...
     * @var string
     */
    protected $signature = 'ifs:import-tnt-purchase-invoices';
     ...
     * @var string
     */
    protected $description = 'Reads purchase files (pushed via FTP by TNT) and populates purchase invoice tables';
    ...
    private function createPurchaseInvoice($row)
    {
        ...
        $this->purchaseInvoice = PurchaseInvoice::whereInvoiceNumber($invoiceNumber)->whereCarrierId(4)->first();
